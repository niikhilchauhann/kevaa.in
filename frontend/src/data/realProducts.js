...
export const products = {
  ...
  categoryProducts: [
    ...
    },
    {
      ...
      image: brassDiyaImg,
      images: [brassDiyaImg],
      description: "A beautifully crafted brass diya for festive decor and rituals.",
    ...
    },
    {
      ...
      description: "Handcrafted traditional poshak in silk for deities.",
    ...
    },
    {
      ...
      image: attarRoseImg,
      images: [attarRoseImg],
      description: "Long-lasting fragrance made with real rose petals. 100% natural and alcohol-free.",
    ...
    image: tulsiMalaImg,
    images: [tulsiMalaImg],
    description: "Tulsi mala for spiritual chanting and peace.",
  ...
  },
  {
    ...
    description: "All essentials for daily Havan rituals.",
